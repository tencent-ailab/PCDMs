...
class Stage2_InapintUNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        my_pose_cond: Optional[torch.Tensor] = None,
        ...
        timesteps = timesteps.expand(sample.shape[0])  # [bs]

        t_emb = self.time_proj(timesteps) # [bs, 320]
        ...
        # 2. pre-process
        sample = self.conv_in(sample) + my_pose_cond
