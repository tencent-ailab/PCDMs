...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_encoder_p_path",type=str,default="./dinov2-giant",
        help="Path to pretrained model or model identifier from huggingface.co/models.",)
    parser.add_argument("--img_path", type=str,default="/mnt/aigc_cq/private/feishen/datasets/deepfashing/train_all_png/", help="image path", )
    parser.add_argument("--pose_path", type=str,default="/mnt/aigc_cq/private/feishen/datasets/deepfashing/openpose_all_img/",help="pose path", )
    parser.add_argument("--json_path", type=str,default="/mnt/aigc_cq/private/feishen/datasets/deepfashing/test_data.json",help="json path", )
    ...
    parser.add_argument("--guidance_scale", type=int, default=1.0, help="device number", )
